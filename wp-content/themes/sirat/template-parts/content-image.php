      ...
      <div class="new-text">
        ...
        <?php if( get_theme_mod( 'sirat_toggle_postdate',true) != '' || get_theme_mod( 'sirat_toggle_author',true) != '' || get_theme_mod( 'sirat_toggle_comments',true) != '' || get_theme_mod( 'sirat_toggle_time',true) != '') { ?>
          <div class="post-info">
            ...
            <?php if( get_theme_mod( 'sirat_toggle_comments',true) != '' || get_theme_mod( 'sirat_toggle_comments_hide_show',true) != '') { ?>
              <span class="entry-comments"><span><?php echo esc_html(get_theme_mod('sirat_meta_field_separator','|'));?></span> <i class="<?php echo esc_attr(get_theme_mod('sirat_toggle_comments_icon','fas fa-comments')); ?>"></i><?php comments_number( __('0 Comment', 'sirat'), __('0 Comments', 'sirat'), __('% Comments', 'sirat') ); ?> </span><span><?php echo esc_html(get_theme_mod('sirat_meta_field_separator','|'));?></span> 
            <?php } ?>
