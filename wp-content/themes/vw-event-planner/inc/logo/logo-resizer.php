...
function vw_event_planner_logo_customize_register( $wp_customize ) {
  ...
  $wp_customize->add_setting('vw_event_planner_site_title_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_event_planner_site_title_font_size',array(
		'label'	=> __('Site Title Font Size','vw-event-planner'),
      ...
      'placeholder' => __( '10px', 'vw-event-planner' ),
		...
		'section'=> 'title_tagline',
		'type'=> 'text',
		'active_callback' => 'vw_event_planner_logo_title_hide_show'
	));
  ...
  $wp_customize->add_setting('vw_event_planner_site_tagline_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_event_planner_site_tagline_font_size',array(
		'label'	=> __('Site Tagline Font Size','vw-event-planner'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-event-planner'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'vw-event-planner' ),
    ),
    'priority'    => 12,
		'section'=> 'title_tagline',
		'type'=> 'text',
		'active_callback' => 'vw_event_planner_tagline_hide_show'
	));
}
...
function vw_event_planner_customize_preview_js() {
	wp_enqueue_script( 'vw-event-planner-customizer', esc_url(get_template_directory_uri()) . '/inc/logo/js/customize-preview.js', array( 'jquery', 'customize-preview' ), '201709081119', true );
}
...
function vw_event_planner_customize_controls_js() {
	wp_enqueue_script( 'vw-event-planner-customizer-controls', esc_url(get_template_directory_uri()) . '/inc/logo/js/customize-controls.js', array( 'jquery', 'customize-preview' ), '201709071000', true );
}
