jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_event_planner_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-event-planner-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-event-planner-plugin-install');
                button.addClass('button-primary vw-event-planner-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-event-planner-recommended-plugins').css('display','block');
    ...
    $(document).on('click', '.vw-event-planner-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-event-planner-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-event-planner-recommended-plugins').css('display','none');
    });
